  ...
  return (
    ...
    >
      ...
      >
        ...
        <span 
          ref={microLabelRef}
          className="absolute micro-label text-cyan"
          style={{ left: '6.5%', top: '10%' }}
        >
        ...
        <div 
          className="absolute"
          style={{ left: '6.5%', top: '16%', width: '42%' }}
        >
          <h1 
            ref={headlineRef}
            className="headline-1 text-primary-light"
          >
            {words.map((word, i) => (
        ...
        <p 
          ref={subheadlineRef}
          className="absolute body-text"
          style={{ left: '6.5%', top: '48%', width: '38%' }}
        >
          DSM integrates engineering, analytics, and integration to improve reliability, 
          performance, and operational decision-making across mission-critical environments.
        </p>
      ...
      >
        <p className="micro-label text-secondary-light mb-1">
          Engineering-Validated • IT/OT Integration • 24/7 Mission-Critical Ready
        </p>
