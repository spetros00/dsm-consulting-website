...
import { ArrowRight, Lightbulb, Link2, BarChart3 } from 'lucide-react';
...
export default function Services() {
  ...
  const services = [
    {
      ...
      description: 'Roadmaps, pilots, and governance for facilities data.',
    },
    {
      icon: Link2,
      title: 'Systems Integration',
      description: 'Connect BMS, EPMS, CMMS, and cloud analytics.',
    },
    {
      icon: BarChart3,
      title: 'Analytics & Automation',
      description: 'Dashboards, alerts, and predictive workflows.',
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h2 className="headline-2 text-primary-light mb-6">
            Services built for complex environments.
          </h2>
          <p className="body-text mb-8">
            Strategy, implementation, and continuous improvement—without the bloat.
          </p>
        ...
        >
          {services.map((service, i) => (
            <div 
              key={i}
              className="service-card glass-card p-6 hover:border-cyan/30 transition-all duration-300 hover:-translate-y-1"
            >
      ...
      >
        <p className="body-text text-sm">
          Scalable. Secure. Designed for operators.
        </p>
      </div>
    </section>
  );
